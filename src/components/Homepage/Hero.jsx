        ...
        <section className="bg-white min-h-screen flex items-center">
            <div className="max-w-6xl mx-auto px-6 py-16 flex flex-col lg:flex-row items-center gap-12 w-full">
                ...
                <div className="flex-1 flex justify-center relative">
                    {/* Floating icons */}
                    <div className="absolute top-4 left-8 bg-white shadow-md rounded-xl p-2 text-2xl">💻</div>
                    <div className="absolute top-4 right-8 bg-white shadow-md rounded-xl p-2 text-2xl">📊</div>
                    <div className="absolute bottom-8 left-4 bg-white shadow-md rounded-xl p-2 text-2xl">🏆</div>
